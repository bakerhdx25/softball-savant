...
const LEADERBOARD_GROUPS = {
  position: [
    ...
    ["hitting", "Hitting", [["player","Player","text"],["teams","Team","teams"],["PA","PA","int"],["H","H","int"],["HR","HR","int"],["BB","BB","int"],["SO","SO","int"],["wOBA","wOBA","rate"],["wRAA","wRAA Runs","signed"],["batting_war","Bat WAR","signed"],["position_war","WAR","signed"]]],
    ["running", "Baserunning", [["player","Player","text"],["teams","Team","teams"],["PA","PA","int"],["advancement_opportunities","Adv Opp","int"],["baserunning_component_runs","BsR Runs","signed"],["sb_cs_runs","SB/CS Runs","signed"],["double_play_avoidance_runs","DP Runs","signed"],["baserunning_war","BsR WAR","signed"]]],
    ["fielding", "Fielding", [["player","Player","text"],["teams","Team","teams"],["PA","PA","int"],["range_runs","Range Runs","signed"],["arm_runs","Arm Runs","signed"],["defense_runs","Def Runs","signed"],["defense_war","Def WAR","signed"],["catcher_steal_attempts","C Att","int"],["catcher_caught_stealing","C CS","int"],["catcher_cs_rate","C CS%","pct"],["catcher_throwing_runs","C Throw Runs","signed"]]],
  ],
  pitching: [
